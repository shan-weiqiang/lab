...
namespace HelloWorldModule {
    ...
    {
        setName("HelloWorldModule::HelloWorld");
        uint32_t type_size =
    #if FASTCDR_VERSION_MAJOR == 1
            static_cast<uint32_t>(HelloWorld::getMaxCdrSerializedSize());
    #else
            HelloWorldModule_HelloWorld_max_cdr_typesize;
    #endif
        type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
        m_typeSize = type_size + 4; /*encapsulation*/
        m_isGetKeyDefined = false;
        uint32_t keyLength = HelloWorldModule_HelloWorld_max_key_cdr_typesize > 16 ? HelloWorldModule_HelloWorld_max_key_cdr_typesize : 16;
            ...
            bool force_md5)
    {
        ...
        eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
                HelloWorldModule_HelloWorld_max_key_cdr_typesize);
    ...
    #endif // FASTCDR_VERSION_MAJOR == 1
        if (force_md5 || HelloWorldModule_HelloWorld_max_key_cdr_typesize > 16)
        {
            m_md5.init();
    #if FASTCDR_VERSION_MAJOR == 1
